...
// Функция для получения протоколов из БД
async function getProtocolsFromDatabase(network?: string) {
...
export async function GET(
    ...
    try {
        ...
        const protocols = await getProtocolsFromDatabase(networkParam);
